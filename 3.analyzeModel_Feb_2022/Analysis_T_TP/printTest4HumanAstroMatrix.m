...
VarNames_TP = {'TestSolutionName','Primary','iPS_Ctrl','iPS_BD','iPS_BD_R','iPS_BD_NR', 'TestSolutionGroup', 'TestedMetabolite','TestedModel'};
...
VarNames_T = {'TestSolutionName','Primary','iPS_Ctrl','iPS_BD','iPS_BD_R','iPS_BD_NR', 'TestSolutionGroup', 'TestedMetabolite', 'TestedModel'};
