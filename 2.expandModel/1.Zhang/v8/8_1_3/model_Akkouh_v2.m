function[filter_1, filter_2, filter_3, rxnList_down, rxnList_up_f, rxnList_up_b, model_Akkouh, FSr_significant_L, FSr_significant_H, subSystem_L, subSystem_H, relaxed_AllRxns_LB, relaxed_AllRxns_UB, relaxed_UpRxns_LB, relaxed_UpRxns_UB, DiffRxns_SetDiff] = expose(model, filename);
tic;
...
% clear rxnList_up rxnList_down;
% rxnList_up = unique(datasample(model.rxns,10));
...
deltaModel = model;
[intis,k] = ismember(deltaModel.rxns,(rxnList_up_f));
...
printFluxBounds(deltaModel,rxnList_up_f);
