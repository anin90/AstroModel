...
%% MODEL_norm_t2
    ...
    % bd_lumped
    rxnList = importdata('bd_tbl_norm_t2/bd_lumped.csv'); 
    model = iAstro_iPS_Ctrl_TP_norm_t2;
    FSrTbl = FluxDiff_iPS_Ctrl_TP_norm_t2_vs_iPS_BD_TP_norm_t2;
    [bd_lumped] = annotateRxnList(model, rxnList, FSrTbl);
 
    % bd_responder
    rxnList = importdata('bd_tbl_norm_t2/bd_responder.csv'); 
    model = iAstro_iPS_Ctrl_TP_norm_t2;
    FSrTbl = FluxDiff_iPS_Ctrl_TP_norm_t2_vs_iPS_BD_R_TP_norm_t2;
    [bd_responder] = annotateRxnList(model, rxnList, FSrTbl);
    
    % bd_nonresponder
    rxnList = importdata('bd_tbl_norm_t2/bd_nonresponder.csv'); 
    model = iAstro_iPS_Ctrl_TP_norm_t2;
    FSrTbl = FluxDiff_iPS_Ctrl_TP_norm_t2_vs_iPS_BD_NR_TP_norm_t2;
    [bd_nonresponder] = annotateRxnList(model, rxnList, FSrTbl);
    
    writetable(bd_lumped, 'bd_tbl_norm_t2/bd_lumped.csv', 'WriteVariableNames', true, 'Delimiter','\t');
    writetable(bd_responder, 'bd_tbl_norm_t2/bd_responder.csv', 'WriteVariableNames', true, 'Delimiter','\t');
    writetable(bd_nonresponder, 'bd_tbl_norm_t2/bd_nonresponder.csv', 'WriteVariableNames', true, 'Delimiter','\t');
