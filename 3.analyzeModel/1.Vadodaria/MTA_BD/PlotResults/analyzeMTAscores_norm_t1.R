...
pdf("mta_tbl_prctile_top_norm_t1/analyzeMTAscores_norm_t1.pdf")
...
# Load data
	Ctrl_to_Primary = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_norm_t1/Vadodaria_Ctrl_to_Primary.csv", header = T, sep = "\t")
	Primary_to_Ctrl = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_norm_t1/Vadodaria_Primary_to_Ctrl.csv", header = T, sep = "\t")
	Ctrl_to_BD = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_norm_t1/Vadodaria_Ctrl_to_BD.csv", header = T, sep = "\t")
	BD_to_Ctrl = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_norm_t1/Vadodaria_BD_to_Ctrl.csv", header = T, sep = "\t")
	Ctrl_to_BD_R = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_norm_t1/Vadodaria_Ctrl_to_BD_R.csv", header = T, sep = "\t")
	BD_R_to_Ctrl = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_norm_t1/Vadodaria_BD_R_to_Ctrl.csv", header = T, sep = "\t")
	Ctrl_to_BD_NR = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_norm_t1/Vadodaria_Ctrl_to_BD_NR.csv", header = T, sep = "\t")
	BD_NR_to_Ctrl = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_norm_t1/Vadodaria_BD_NR_to_Ctrl.csv", header = T, sep = "\t")
	R_to_NR = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_norm_t1/Vadodaria_R_to_NR.csv", header = T, sep = "\t")
	NR_to_R = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_norm_t1/Vadodaria_NR_to_R.csv", header = T, sep = "\t")
...
# FilterMTAscore, all
	...
	write.table(dat_all[[1]], "mta_tbl_prctile_all_norm_t1/Ctrl_to_Primary.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[2]], "mta_tbl_prctile_all_norm_t1/Primary_to_Ctrl.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[3]], "mta_tbl_prctile_all_norm_t1/Ctrl_to_BD.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[4]], "mta_tbl_prctile_all_norm_t1/BD_to_Ctrl.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[5]], "mta_tbl_prctile_all_norm_t1/Ctrl_to_BD_R.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[6]], "mta_tbl_prctile_all_norm_t1/BD_R_to_Ctrl.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[7]], "mta_tbl_prctile_all_norm_t1/Ctrl_to_BD_NR.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[8]], "mta_tbl_prctile_all_norm_t1/BD_NR_to_Ctrl.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[9]], "mta_tbl_prctile_all_norm_t1/R_to_NR.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[10]], "mta_tbl_prctile_all_norm_t1/NR_to_R.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
...
###################################
	...
	write.table(mat, "mta_tbl_prctile_top_norm_t1/MTA_Table_BD_norm_t1.csv", sep = "\t", quote = FALSE, row.names = TRUE, col.names=F)

	mat <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_prctile_top_norm_t1/MTA_Table_BD_norm_t1.csv",
			header = T, sep = "\t")
...
################
	...
	length(bd_lumped_a)
	#~ write.table(bd_lumped_a, "mta_tbl_prctile_top_norm_t1/bd_lumped_a.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
	...
	length(bd_lumped_b)
	#~ write.table(bd_lumped_b, "mta_tbl_prctile_top_norm_t1/bd_lumped_b.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
	...
	length(bd_lumped_c)
	#~ write.table(bd_lumped_c, "mta_tbl_prctile_top_norm_t1/bd_lumped_c.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
	...
	length(bd_lumped_d)
	#~ write.table(bd_lumped_d, "mta_tbl_prctile_top_norm_t1/bd_lumped_d.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
	...
	length(bd_r)
	#~ write.table(bd_r, "mta_tbl_prctile_top_norm_t1/bd_r.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
	...
	length(bd_nr)
	#~ write.table(bd_nr, "mta_tbl_prctile_top_norm_t1/bd_nr.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
################################
	...
	write.table(bd_lumped, "mta_tbl_prctile_top_norm_t1/bd_lumped.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	...
	write.table(bd_responder, "mta_tbl_prctile_top_norm_t1/bd_responder.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	...
	write.table(bd_nonresponder, "mta_tbl_prctile_top_norm_t1/bd_nonresponder.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
