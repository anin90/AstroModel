...
# Load data
	Ctrl_to_Primary = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/2.Koskuvi/MTA_ST/PlotResults/mta_tbl_norm_t2/Koskuvi_Ctrl_to_Primary.csv", header = T, sep = "\t")
	Primary_to_Ctrl = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/2.Koskuvi/MTA_ST/PlotResults/mta_tbl_norm_t2/Koskuvi_Primary_to_Ctrl.csv", header = T, sep = "\t")
	Ctrl_to_HT = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/2.Koskuvi/MTA_ST/PlotResults/mta_tbl_norm_t2/Koskuvi_Ctrl_to_HT.csv", header = T, sep = "\t")
	HT_to_Ctrl = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/2.Koskuvi/MTA_ST/PlotResults/mta_tbl_norm_t2/Koskuvi_HT_to_Ctrl.csv", header = T, sep = "\t")
	Ctrl_to_ST = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/2.Koskuvi/MTA_ST/PlotResults/mta_tbl_norm_t2/Koskuvi_Ctrl_to_ST.csv", header = T, sep = "\t")
	ST_to_Ctrl = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/2.Koskuvi/MTA_ST/PlotResults/mta_tbl_norm_t2/Koskuvi_ST_to_Ctrl.csv", header = T, sep = "\t")
...
# FilterMTAscore, all
	...
	write.table(dat_all[[3]], "mta_tbl_prctile_all_norm_t2/Ctrl_to_HT.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[4]], "mta_tbl_prctile_all_norm_t2/HT_to_Ctrl.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[5]], "mta_tbl_prctile_all_norm_t2/Ctrl_to_ST.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[6]], "mta_tbl_prctile_all_norm_t2/ST_to_Ctrl.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
...
###################################
	...
	write.table(mat, "mta_tbl_prctile_top_norm_t2/MTA_Table_ST_norm_t2.csv", sep = "\t", quote = FALSE, row.names = TRUE, col.names=F)

	mat <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/2.Koskuvi/MTA_ST/PlotResults/mta_tbl_prctile_top_norm_t2/MTA_Table_ST_norm_t2.csv",
			header = T, sep = "\t")
...
################
	...
	length(st_rxns)
	write.table(st_rxns, "mta_tbl_prctile_top_norm_t2/st_rxns.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
################################
	...
	write.table(st_rxns, "mta_tbl_prctile_top_norm_t2/st_rxns.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
...
# Fig.1: Number of rxns per subSystem (st_rxns)
	par(mfrow=c(1,1))
	iPS_ST_TP <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/Annotations/AnnotateRxnSubsystems/Rxns_iPS_SCZ_ST_TP_norm_t2.csv", header = T, sep = "\t")
