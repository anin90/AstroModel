...
%% bd_30_norm
    ...
    rxnList = importdata('bd_30_norm.csv'); 
...
%% bd_38_norm
    ...
    rxnList = importdata('bd_38_norm.csv');
    model = iAstro_iPS_Ctrl_TP_norm;
    [tf,loc] = ismember(model.rxns, rxnList); [~,p] = sort(loc(tf)); idx = find(tf); idx = idx(p);
    subSystem = model.subSystems(idx);
    subSystem = [subSystem{:}]';
...
%% bd_36_norm
    ...
    rxnList = importdata('bd_36_norm.csv');
    model = iAstro_iPS_Ctrl_TP_norm;
    [tf,loc] = ismember(model.rxns, rxnList); [~,p] = sort(loc(tf)); idx = find(tf); idx = idx(p);
    subSystem = model.subSystems(idx);
    subSystem = [subSystem{:}]';
...
%% bd_95_norm
    ...
    rxnList = importdata('bd_95_norm.csv');
    model = iAstro_iPS_Ctrl_TP_norm;
    [tf,loc] = ismember(model.rxns, rxnList); [~,p] = sort(loc(tf)); idx = find(tf); idx = idx(p);
    subSystem = model.subSystems(idx);
    subSystem = [subSystem{:}]';
...
%% bd_r_155_norm
    ...
    rxnList = importdata('bd_r_155_norm.csv');
    model = iAstro_iPS_Ctrl_TP_norm;
    [tf,loc] = ismember(model.rxns, rxnList); [~,p] = sort(loc(tf)); idx = find(tf); idx = idx(p);
    subSystem = model.subSystems(idx);
    subSystem = [subSystem{:}]';
...
%% bd_nr_148_norm
    ...
    rxnList = importdata('bd_nr_148_norm.csv');
    model = iAstro_iPS_Ctrl_TP_norm;
    [tf,loc] = ismember(model.rxns, rxnList); [~,p] = sort(loc(tf)); idx = find(tf); idx = idx(p);
    subSystem = model.subSystems(idx);
    subSystem = [subSystem{:}]';
...
writetable(bd_199_tbl, 'bd_199_tbl_norm.csv', 'WriteVariableNames', true, 'Delimiter','\t');
writetable(bd_r_185_tbl, 'bd_r_185_tbl_norm.csv', 'WriteVariableNames', true, 'Delimiter','\t');
writetable(bd_nr_184_tbl, 'bd_nr_184_tbl_norm.csv', 'WriteVariableNames', true, 'Delimiter','\t');

%%
clearvars -except bd_199_tbl bd_r_185_tbl bd_nr_184_tbl

%%
save('bd_tbl_norm.mat');