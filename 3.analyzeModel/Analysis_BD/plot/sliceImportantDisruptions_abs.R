...
mat <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/Analysis_BD/plot/bd_tbl_abs/FSR_Table_BD_abs.csv",
		header = T, sep = "\t")
...
bd_9 = setdiff(xInt,y)
length(bd_9)
write.table(bd_9, "bd_tbl_abs/bd_9_abs.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
length(bd_29)
write.table(bd_29, "bd_tbl_abs/bd_29_abs.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
length(bd_58)
write.table(bd_58, "bd_tbl_abs/bd_58_abs.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
length(bd_113)
write.table(bd_113, "bd_tbl_abs/bd_113_abs.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
length(bd_r_63)
write.table(bd_r_63, "bd_tbl_abs/bd_r_63_abs.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
length(bd_nr_675)
write.table(bd_nr_675, "bd_tbl_abs/bd_nr_675_abs.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
