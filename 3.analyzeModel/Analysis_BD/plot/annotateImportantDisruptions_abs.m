...
%% bd_9_abs
    ...
    rxnList = importdata('bd_tbl_abs/bd_9_abs.csv'); 
...
%% bd_29_abs
    ...
    rxnList = importdata('bd_tbl_abs/bd_29_abs.csv');
    model = iAstro_iPS_Ctrl_TP_abs;
    [tf,loc] = ismember(model.rxns, rxnList); [~,p] = sort(loc(tf)); idx = find(tf); idx = idx(p);
    subSystem = model.subSystems(idx);
    subSystem = [subSystem{:}]';
...
%% bd_58_abs
    ...
    rxnList = importdata('bd_tbl_abs/bd_58_abs.csv');
    model = iAstro_iPS_Ctrl_TP_abs;
    [tf,loc] = ismember(model.rxns, rxnList); [~,p] = sort(loc(tf)); idx = find(tf); idx = idx(p);
    subSystem = model.subSystems(idx);
    subSystem = [subSystem{:}]';
...
%% bd_113_abs
    ...
    rxnList = importdata('bd_tbl_abs/bd_113_abs.csv');
    model = iAstro_iPS_Ctrl_TP_abs;
    [tf,loc] = ismember(model.rxns, rxnList); [~,p] = sort(loc(tf)); idx = find(tf); idx = idx(p);
    subSystem = model.subSystems(idx);
    subSystem = [subSystem{:}]';
...
%% bd_r_63_abs
    ...
    rxnList = importdata('bd_tbl_abs/bd_r_63_abs.csv');
    model = iAstro_iPS_Ctrl_TP_abs;
    [tf,loc] = ismember(model.rxns, rxnList); [~,p] = sort(loc(tf)); idx = find(tf); idx = idx(p);
    subSystem = model.subSystems(idx);
    subSystem = [subSystem{:}]';
...
%% bd_nr_675_abs
    ...
    rxnList = importdata('bd_tbl_abs/bd_nr_675_abs.csv');
    model = iAstro_iPS_Ctrl_TP_abs;
    [tf,loc] = ismember(model.rxns, rxnList); [~,p] = sort(loc(tf)); idx = find(tf); idx = idx(p);
    subSystem = model.subSystems(idx);
    subSystem = [subSystem{:}]';
...
writetable(bd_209_tbl, 'bd_tbl_abs/bd_209_tbl_abs.csv', 'WriteVariableNames', true, 'Delimiter','\t');
writetable(bd_r_72_tbl, 'bd_tbl_abs/bd_r_72_tbl_abs.csv', 'WriteVariableNames', true, 'Delimiter','\t');
writetable(bd_nr_733_tbl, 'bd_tbl_abs/bd_nr_733_tbl_abs.csv', 'WriteVariableNames', true, 'Delimiter','\t');
