...
addpath('/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/Analysis_BD/plot/bd_tbl_significant_norm_t2')

% Load BD_Significant Rxns
bd_significant_lumped = importfile('bd_tbl_significant_norm_t2/bd_lumped_rxns_fdr_norm_t2.csv');
bd_significant_r = importfile('bd_tbl_significant_norm_t2/bd_r_rxns_fdr_norm_t2.csv');
bd_significant_nr = importfile('bd_tbl_significant_norm_t2/bd_nr_rxns_fdr_norm_t2.csv');

%% bd_significant_lumped
% rxns
model = iAstro_iPS_BD_TP_norm_t2; dat_rxns = bd_significant_lumped.rxnList;
...
%% bd_significant_r
% rxns
model = iAstro_iPS_BD_R_TP_norm_t2; dat_rxns = bd_significant_r.rxnList;
...
%% bd_significant_nr
% rxns
model = iAstro_iPS_BD_NR_TP_norm_t2; dat_rxns = bd_significant_nr.rxnList;
...
writetable(bd_significant_lumped, 'bd_tbl_significant_norm_t2/FinalTable_BD_Lumped_norm_t2.csv', 'WriteVariableNames', true, 'Delimiter','\t');
...
writetable(bd_significant_r, 'bd_tbl_significant_norm_t2/FinalTable_BD_Responder_norm_t2.csv', 'WriteVariableNames', true, 'Delimiter','\t');
...
writetable(bd_significant_nr, 'bd_tbl_significant_norm_t2/FinalTable_BD_NonResponder_norm_t2.csv', 'WriteVariableNames', true, 'Delimiter','\t');
...
%%
save('bd_tbl_significant_norm_t2/final_bd_rxns_norm_t2.mat');
%%
toc;
