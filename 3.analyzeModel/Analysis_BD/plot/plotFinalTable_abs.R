...
pdf("bd_tbl_significant_abs/plotFinalTable_abs.pdf", width=7, height=3)
...
# load subsystems
bd_lumped_subsystem_fdr <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/Analysis_BD/plot/bd_tbl_significant_abs/bd_lumped_subsystem_fdr_abs.csv",
		header = T, sep = "\t")
bd_r_subsystem_fdr <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/Analysis_BD/plot/bd_tbl_significant_abs/bd_r_subsystem_fdr_abs.csv",
		header = T, sep = "\t")		
bd_nr_subsystem_fdr <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/Analysis_BD/plot/bd_tbl_significant_abs/bd_nr_subsystem_fdr_abs.csv",
		header = T, sep = "\t")

# load rxns
bd_lumped_rxns_fdr <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/Analysis_BD/plot/bd_tbl_significant_abs/bd_lumped_rxns_fdr_abs.csv",
		header = T, sep = "\t")
bd_r_rxns_fdr <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/Analysis_BD/plot/bd_tbl_significant_abs/bd_r_rxns_fdr_abs.csv",
		header = T, sep = "\t")		
bd_nr_rxns_fdr <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/Analysis_BD/plot/bd_tbl_significant_abs/bd_nr_rxns_fdr_abs.csv",
		header = T, sep = "\t")
