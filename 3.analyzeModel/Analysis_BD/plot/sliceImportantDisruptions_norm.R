...
pdf("bd_tbl_norm/FSR_UpSet_BD_norm.pdf")
...
write.table(mat, "bd_tbl_norm/FSR_Table_BD_norm.csv", sep = "\t", quote = FALSE, row.names = TRUE, col.names=F)

mat <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/Analysis_BD/plot/bd_tbl_norm/FSR_Table_BD_norm.csv",
		header = T, sep = "\t")
...
svg(filename="bd_tbl_norm/FSR_UpSet_BD_TP_norm.svg")
p 
dev.off()
...
length(bd_30)
write.table(bd_30, "bd_tbl_norm/bd_30_norm.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
length(bd_38)
write.table(bd_38, "bd_tbl_norm/bd_38_norm.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
length(bd_36)
write.table(bd_36, "bd_tbl_norm/bd_36_norm.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
length(bd_95)
write.table(bd_95, "bd_tbl_norm/bd_95_norm.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
length(bd_r_155)
write.table(bd_r_155, "bd_tbl_norm/bd_r_155_norm.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
length(bd_nr_148)
write.table(bd_nr_148, "bd_tbl_norm/bd_nr_148_norm.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
