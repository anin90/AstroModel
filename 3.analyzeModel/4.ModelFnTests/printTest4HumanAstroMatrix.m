...
%% model_abs
    ...
    [TestResults_iPS_Ctrl] = Test4HumanAstro(iAstro_iPS_Ctrl_TP_abs);
    ...
    VarNames_TP = {'TestSolutionName','Primary_Ctrl','iPS_Ctrl','iPS_BD','iPS_BD_R','iPS_BD_NR', 'TestSolutionGroup', 'TestedMetabolite','TestedModel'};
    Test4HumanAstro_abs = table(TestResults_Primary.TestSolutionName, TestResults_Primary.TestSolution, TestResults_iPS_Ctrl.TestSolution, TestResults_iPS_BD.TestSolution, TestResults_iPS_BD_R.TestSolution, TestResults_iPS_BD_NR.TestSolution, TestResults_Primary.TestSolutionGroup, TestResults_Primary.TestedMetabolite, TestResults_Primary.TestedModel, 'VariableNames', VarNames_TP);
...
%% model_norm_t1
    ...
    [TestResults_iPS_Ctrl] = Test4HumanAstro(iAstro_iPS_Ctrl_TP_norm_t1);
    ...
    VarNames_TP = {'TestSolutionName','Primary_Ctrl','iPS_Ctrl','iPS_BD','iPS_BD_R','iPS_BD_NR', 'TestSolutionGroup', 'TestedMetabolite','TestedModel'};
    Test4HumanAstro_norm_t1 = table(TestResults_Primary.TestSolutionName, TestResults_Primary.TestSolution, TestResults_iPS_Ctrl.TestSolution, TestResults_iPS_BD.TestSolution, TestResults_iPS_BD_R.TestSolution, TestResults_iPS_BD_NR.TestSolution, TestResults_Primary.TestSolutionGroup, TestResults_Primary.TestedMetabolite, TestResults_Primary.TestedModel, 'VariableNames', VarNames_TP);
...
%% model_norm_t2
    ...
    [TestResults_iPS_Ctrl] = Test4HumanAstro(iAstro_iPS_Ctrl_TP_norm_t2);
    ...
    VarNames_TP = {'TestSolutionName','Primary_Ctrl','iPS_Ctrl','iPS_BD','iPS_BD_R','iPS_BD_NR', 'TestSolutionGroup', 'TestedMetabolite','TestedModel'};
    Test4HumanAstro_norm_t2 = table(TestResults_Primary.TestSolutionName, TestResults_Primary.TestSolution, TestResults_iPS_Ctrl.TestSolution, TestResults_iPS_BD.TestSolution, TestResults_iPS_BD_R.TestSolution, TestResults_iPS_BD_NR.TestSolution, TestResults_Primary.TestSolutionGroup, TestResults_Primary.TestedMetabolite, TestResults_Primary.TestedModel, 'VariableNames', VarNames_TP);
