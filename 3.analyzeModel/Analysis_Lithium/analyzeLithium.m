...
m_in = vertcat(union(dat.rxnList_down, union (dat.rxnList_up_f, dat.rxnList_up_b)));
T_in = table(m_in);
writetable(T_out,'iPS_Ctrl_TP_Akkouh_Output.csv','WriteVariableNames', true, 'Delimiter','\t');
...
m_in = vertcat(union(dat.rxnList_down, union (dat.rxnList_up_f, dat.rxnList_up_b)));
T_in = table(m_in);
writetable(T_out,'iPS_Ctrl_TP_GSE66276_Output.csv','WriteVariableNames', true, 'Delimiter','\t');
...
m_in = vertcat(union(dat.rxnList_down, union (dat.rxnList_up_f, dat.rxnList_up_b)));
T_in = table(m_in);
writetable(T_out,'iPS_Ctrl_TP_GSE132397_Output.csv','WriteVariableNames', true, 'Delimiter','\t');
...
m_in = vertcat(union(dat.rxnList_down, union (dat.rxnList_up_f, dat.rxnList_up_b)));
T_in = table(m_in);
writetable(T_out,'iPS_BD_TP_Akkouh_Output.csv','WriteVariableNames', true, 'Delimiter','\t');
...
m_in = vertcat(union(dat.rxnList_down, union (dat.rxnList_up_f, dat.rxnList_up_b)));
T_in = table(m_in);
writetable(T_out,'iPS_BD_TP_GSE66276_Output.csv','WriteVariableNames', true, 'Delimiter','\t');
...
m_in = vertcat(union(dat.rxnList_down, union (dat.rxnList_up_f, dat.rxnList_up_b)));
T_in = table(m_in);
writetable(T_out,'iPS_BD_TP_GSE132397_Output.csv','WriteVariableNames', true, 'Delimiter','\t');
