...
T_in = table(m_in);
writetable(T_out,'iAstro_Primary_TP_Untreated_vs_Lithium_Output.csv','WriteVariableNames', true, 'Delimiter','\t');
writetable(T_in,'iAstro_Primary_TP_Untreated_vs_Lithium_Input.csv','WriteVariableNames', true, 'Delimiter','\t');
