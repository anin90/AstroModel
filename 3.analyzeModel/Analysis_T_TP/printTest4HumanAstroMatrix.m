...
VarNames_TP = {'TestSolutionName','Primary_TP','iPS_Ctrl_TP','iPS_BD_TP','iPS_BD_R_TP','iPS_BD_NR_TP', 'TestSolutionGroup', 'TestedMetabolite','TestedModel'};
Test4HumanAstro_TP = table(TestResults_iAstro_Primary_TP.TestSolutionName, TestResults_iAstro_Primary_TP.TestSolution, TestResults_iAstro_iPS_Ctrl_TP.TestSolution, TestResults_iAstro_iPS_BD_TP.TestSolution, TestResults_iAstro_iPS_BD_R_TP.TestSolution, TestResults_iAstro_iPS_BD_NR_TP.TestSolution, TestResults_iAstro_Primary_TP.TestSolutionGroup, TestResults_iAstro_Primary_TP.TestedMetabolite, TestResults_iAstro_Primary_TP.TestedModel, 'VariableNames', VarNames_TP);
...
VarNames_T = {'TestSolutionName','Primary_T','iPS_Ctrl_T','iPS_BD_T','iPS_BD_R_T','iPS_BD_NR_T', 'TestSolutionGroup', 'TestedMetabolite', 'TestedModel'};
Test4HumanAstro_T = table(TestResults_iAstro_Primary_T.TestSolutionName, TestResults_iAstro_Primary_T.TestSolution, TestResults_iAstro_iPS_Ctrl_T.TestSolution, TestResults_iAstro_iPS_BD_T.TestSolution, TestResults_iAstro_iPS_BD_R_T.TestSolution, TestResults_iAstro_iPS_BD_NR_T.TestSolution, TestResults_iAstro_Primary_T.TestSolutionGroup, TestResults_iAstro_Primary_T.TestedMetabolite, TestResults_iAstro_Primary_T.TestedModel, 'VariableNames', VarNames_T);
