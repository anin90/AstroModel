function[Tbl] = mapDiffExpToRxns(model, filename)
tic;
...
% FILTER_3: EXCLUDE GENES WITHOUT HPA EVIDENCE  % this ain't required
...
Tbl = struct('filter_1', {filter_1}, 'filter_2', {filter_2}, 'rxnList_down', {rxnList_down}, 'rxnList_up', {rxnList_up});
