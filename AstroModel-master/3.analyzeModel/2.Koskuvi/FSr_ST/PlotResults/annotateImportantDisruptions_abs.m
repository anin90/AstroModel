...
%% MODEL_ABS
    ...
    % st_rxns
    rxnList = importdata('st_tbl_abs/st_rxns.csv'); 
    model = iAstro_iPS_SCZ_Ctrl_TP_abs;
    FSrTbl = FluxDiff_iPS_SCZ_Ctrl_TP_abs_vs_iPS_SCZ_ST_TP_abs;
    [st_rxns] = annotateRxnList(model, rxnList, FSrTbl);
    
    writetable(st_rxns, 'st_tbl_abs/st_rxns.csv', 'WriteVariableNames', true, 'Delimiter','\t');

%%
clearvars -except st_rxns

%%
save('st_tbl_abs/st_tbl_abs.mat');
