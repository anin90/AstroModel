...
# Load data
	Ctrl_to_Primary = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_abs/Vadodaria_Ctrl_to_Primary_a.csv", header = T, sep = "\t")
	Primary_to_Ctrl = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_abs/Vadodaria_Primary_to_Ctrl_a.csv", header = T, sep = "\t")
	Ctrl_to_BD = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_abs/Vadodaria_Ctrl_to_BD_a.csv", header = T, sep = "\t")
	BD_to_Ctrl = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_abs/Vadodaria_BD_to_Ctrl_a.csv", header = T, sep = "\t")
	Ctrl_to_BD_R = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_abs/Vadodaria_Ctrl_to_BD_R_a.csv", header = T, sep = "\t")
	BD_R_to_Ctrl = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_abs/Vadodaria_BD_R_to_Ctrl_a.csv", header = T, sep = "\t")
	Ctrl_to_BD_NR = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_abs/Vadodaria_Ctrl_to_BD_NR_a.csv", header = T, sep = "\t")
	BD_NR_to_Ctrl = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_abs/Vadodaria_BD_NR_to_Ctrl_a.csv", header = T, sep = "\t")
	R_to_NR = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_abs/Vadodaria_R_to_NR_a.csv", header = T, sep = "\t")
	NR_to_R = read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_abs/Vadodaria_NR_to_R_a.csv", header = T, sep = "\t")
...
# FilterMTAscore, all
	...
	write.table(dat_all[[3]], "mta_tbl_prctile_all_abs/Ctrl_to_BD.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[4]], "mta_tbl_prctile_all_abs/BD_to_Ctrl.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[5]], "mta_tbl_prctile_all_abs/Ctrl_to_BD_R.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[6]], "mta_tbl_prctile_all_abs/BD_R_to_Ctrl.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[7]], "mta_tbl_prctile_all_abs/Ctrl_to_BD_NR.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[8]], "mta_tbl_prctile_all_abs/BD_NR_to_Ctrl.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[9]], "mta_tbl_prctile_all_abs/R_to_NR.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	write.table(dat_all[[10]], "mta_tbl_prctile_all_abs/NR_to_R.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
...
###################################
	...
	write.table(mat, "mta_tbl_prctile_top_abs/MTA_Table_BD_abs.csv", sep = "\t", quote = FALSE, row.names = TRUE, col.names=F)

	mat <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/MTA_BD/PlotResults/mta_tbl_prctile_top_abs/MTA_Table_BD_abs.csv",
			header = T, sep = "\t")
...
################
	...
	length(bd_lumped_a)
	#~ write.table(bd_lumped_a, "mta_tbl_prctile_top_abs/bd_lumped_a.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
	...
	length(bd_lumped_b)
	#~ write.table(bd_lumped_b, "mta_tbl_prctile_top_abs/bd_lumped_b.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
	...
	length(bd_lumped_c)
	#~ write.table(bd_lumped_c, "mta_tbl_prctile_top_abs/bd_lumped_c.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
	...
	length(bd_lumped_d)
	#~ write.table(bd_lumped_d, "mta_tbl_prctile_top_abs/bd_lumped_d.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
	...
	length(bd_r)
	#~ write.table(bd_r, "mta_tbl_prctile_top_abs/bd_r.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
	...
	length(bd_nr)
	#~ write.table(bd_nr, "mta_tbl_prctile_top_abs/bd_nr.csv", sep = "\t", quote = FALSE, row.names = F, col.names=F)
...
################################
	...
	write.table(bd_lumped, "mta_tbl_prctile_top_abs/bd_lumped.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	...
	write.table(bd_responder, "mta_tbl_prctile_top_abs/bd_responder.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	...
	write.table(bd_nonresponder, "mta_tbl_prctile_top_abs/bd_nonresponder.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
...
# Fig.3: Number of rxns per subSystem (bd_lumped)
	par(mfrow=c(1,1))
	iPS_BD_TP <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/Annotations/AnnotateRxnSubsystems/Rxns_iPS_BD_TP_abs.csv", header = T, sep = "\t")
	...
	write.table(bd_lumped_subsystem_fdr, "mta_tbl_prctile_top_significant_abs/bd_lumped_subsystem_fdr.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	bd_lumped_rxns_fdr = bd_lumped[bd_lumped$subSystem_BC %in% bd_lumped_subsystem_fdr$subSystem_BC,]
	write.table(bd_lumped_rxns_fdr, "mta_tbl_prctile_top_significant_abs/bd_lumped_rxns_fdr.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	#write all subsystems to csv
	BD_subsystem_all = combStat
	write.table(BD_subsystem_all, "mta_tbl_prctile_top_abs/BD_subsystem_all.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
...
# Fig.4: Number of rxns per subSystem (bd_responder)
	...
	write.table(bd_r_subsystem_fdr, "mta_tbl_prctile_top_significant_abs/bd_r_subsystem_fdr.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	bd_r_rxns_fdr = bd_responder[bd_responder$subSystem_BRC %in% bd_r_subsystem_fdr$subSystem_BRC,]
	write.table(bd_r_rxns_fdr, "mta_tbl_prctile_top_significant_abs/bd_r_rxns_fdr.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	#write all subsystems to csv
	BD_R_subsystem_all = combStat
	write.table(BD_R_subsystem_all, "mta_tbl_prctile_top_abs/BD_R_subsystem_all.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
...
# Fig.5: Number of rxns per subSystem (bd_nonresponder)
	...
	write.table(bd_nr_subsystem_fdr, "mta_tbl_prctile_top_significant_abs/bd_nr_subsystem_fdr.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	bd_nr_rxns_fdr = bd_nonresponder[bd_nonresponder$subSystem_BNRC %in% bd_nr_subsystem_fdr$subSystem_BNRC,]
	write.table(bd_nr_rxns_fdr, "mta_tbl_prctile_top_significant_abs/bd_nr_rxns_fdr.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	#write all subsystems to csv
	BD_NR_subsystem_all = combStat
	write.table(BD_NR_subsystem_all, "mta_tbl_prctile_top_abs/BD_NR_subsystem_all.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
