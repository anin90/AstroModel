...
bd_lumped <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/FSr_BD/PlotResults/bd_tbl_norm_t2/bd_lumped.csv",
		header = T, sep = "\t")
bd_responder <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/FSr_BD/PlotResults/bd_tbl_norm_t2/bd_responder.csv",
		header = T, sep = "\t")		
bd_nonresponder <- read.csv("/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/FSr_BD/PlotResults/bd_tbl_norm_t2/bd_nonresponder.csv",
		header = T, sep = "\t")
...
# Fig.3: Number of rxns per subSystem (bd_lumped)
	...
	write.table(bd_lumped_subsystem_fdr, "/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/FSr_BD/PlotResults/bd_tbl_significant_norm_t2/bd_lumped_subsystem_fdr_norm_t2.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	bd_lumped_rxns_fdr = bd_lumped[bd_lumped$subSystem %in% bd_lumped_subsystem_fdr$subSystem,]
	write.table(bd_lumped_rxns_fdr, "/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/FSr_BD/PlotResults/bd_tbl_significant_norm_t2/bd_lumped_rxns_fdr_norm_t2.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	#write all subsystems to csv
	BD_subsystem_all = combStat
	write.table(BD_subsystem_all, "/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/FSr_BD/PlotResults/bd_tbl_norm_t2/BD_subsystem_all_norm_t2.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
...
# Fig.4: Number of rxns per subSystem (bd_responder)
	...
	write.table(bd_r_subsystem_fdr, "/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/FSr_BD/PlotResults/bd_tbl_significant_norm_t2/bd_r_subsystem_fdr_norm_t2.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	bd_r_rxns_fdr = bd_responder[bd_responder$subSystem %in% bd_r_subsystem_fdr$subSystem,]
	write.table(bd_r_rxns_fdr, "/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/FSr_BD/PlotResults/bd_tbl_significant_norm_t2/bd_r_rxns_fdr_norm_t2.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	#write all subsystems to csv
	BD_R_subsystem_all = combStat
	write.table(BD_R_subsystem_all, "/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/FSr_BD/PlotResults/bd_tbl_norm_t2/BD_R_subsystem_all_norm_t2.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
...
# Fig.5: Number of rxns per subSystem (bd_nonresponder)
	...
	write.table(bd_nr_subsystem_fdr, "/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/FSr_BD/PlotResults/bd_tbl_significant_norm_t2/bd_nr_subsystem_fdr_norm_t2.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	bd_nr_rxns_fdr = bd_nonresponder[bd_nonresponder$subSystem %in% bd_nr_subsystem_fdr$subSystem,]
	write.table(bd_nr_rxns_fdr, "/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/FSr_BD/PlotResults/bd_tbl_significant_norm_t2/bd_nr_rxns_fdr_norm_t2.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
	#write all subsystems to csv
	BD_NR_subsystem_all = combStat
	write.table(BD_NR_subsystem_all, "/media/anirudh/Work/ADBS_NIMHANS/Thesis/1.Science/Analysis/cobratoolbox/AstroModel/3.analyzeModel/1.Vadodaria/FSr_BD/PlotResults/bd_tbl_norm_t2/BD_NR_subsystem_all_norm_t2.csv", sep = "\t", quote = FALSE, row.names = F, col.names=T)
