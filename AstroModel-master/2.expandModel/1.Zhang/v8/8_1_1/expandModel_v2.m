function[model_EXP, fluxInconsistentRxns_non_media, model_EXP_ASM, fluxInconsistentRxns_media] = expandModel(model);
tic;
%%
...
model = addExchangeRxn(model,'o2[e]', -1000, 0);
...
model=addExchangeRxn(model,{'glu_L[e]'},-1000,1000);
model=addExchangeRxn(model,{'crn[e]'},-1000,1000);
model=addExchangeRxn(model,{'lac_L[e]'},-1000,1000);
model=addExchangeRxn(model,{'lys_L[e]'},-1000,1000);
model=addExchangeRxn(model,{'arg_L[e]'},-1000,1000);
model=addExchangeRxn(model,{'orn[e]'},-1000,1000);
model=addExchangeRxn(model,{'his_L[e]'},-1000,1000);
model=addExchangeRxn(model,{'gln_L[e]'},-1000,1000);
model=addExchangeRxn(model,{'met_L[e]'},-1000,1000);
model=addExchangeRxn(model,{'leu_L[e]'},-1000,1000);
...
model=addExchangeRxn(model,{'ala_L[e]'},-1000,1000);
model=addExchangeRxn(model,{'glc_D[e]'},-1000,1000);
model=addExchangeRxn(model,{'gal[e]'},-1000,1000);
model=addExchangeRxn(model,{'dhdascb[e]'},-1000,1000);
model=addExchangeRxn(model,{'k[e]'},-1000,1000);
model=addExchangeRxn(model,{'chol[e]'},-1000,1000);
model=addExchangeRxn(model,{'ade[e]'},-1000,1000);
model=addExchangeRxn(model,{'adn[e]'},-1000,1000);
model=addExchangeRxn(model,{'triodthy[e]'},-1000,1000);
model=addExchangeRxn(model,{'bhb[e]'},-1000,1000);
model=addExchangeRxn(model,{'thyox_L[e]'},-1000,1000);
model=addExchangeRxn(model,{'tststerone[e]'},-1000,1000);
model=addExchangeRxn(model,{'estradiol[e]'},-1000,1000);
model=addExchangeRxn(model,{'crtsl[e]'},-1000,1000);
model=addExchangeRxn(model,{'aldstrn[e]'},-1000,1000);
model=addExchangeRxn(model,{'crtstrn[e]'},-1000,1000);
model=addExchangeRxn(model,{'cortsn[e]'},-1000,1000);
model=addExchangeRxn(model,{'prgstrn[e]'},-1000,1000);
model=addExchangeRxn(model,{'melatn[e]'},-1000,1000);
model=addExchangeRxn(model,{'hdca[e]'},-1000,1000);
model=addExchangeRxn(model,{'lnlc[e]'},-1000,1000);
model=addExchangeRxn(model,{'octa[e]'},-1000,1000);
model=addExchangeRxn(model,{'but[e]'},-1000,1000);
model=addExchangeRxn(model,{'pnto_R[e]'},-1000,1000);
model=addExchangeRxn(model,{'ttdca[e]'},-1000,1000);
model=addExchangeRxn(model,{'tyr_L[e]'},-1000,1000);
model=addExchangeRxn(model,{'asp_L[e]'},-1000,1000);
...
fluxConsistency = verifyModel(model_EXP,'fluxConsistency',true); fluxInconsistentRxns_non_media = model_EXP.rxns(fluxConsistency.fluxConsistency.consistentReactionBool~=1); clear fluxConsistency;
