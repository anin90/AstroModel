...
**********************************************************************
BrainTasks_New (06-Nov-2019):
>> add ATP demand reaction {'sink_creat[c]','sink_pcreat[c]','EX_pcreat[e]','EX_arg_L[e]','sink_crtn[c]'} to model
>> model size: [5403 x 9639]
