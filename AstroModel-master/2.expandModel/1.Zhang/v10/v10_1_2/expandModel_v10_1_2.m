...
% add cytosol <-> synapse transport rxns
...
model = addReaction(model,'r1050_s','reactionFormula','chsterol[c] <=> chsterol[s]', 'subSystem','Transport, extracellular', 'geneRule','');
model = addReaction(model,'r1116_s','reactionFormula','atp[c] <=> atp[s]', 'subSystem','Transport, extracellular', 'geneRule','');
model = addReaction(model,'ASCBt_s','reactionFormula','ascb_L[c] <=> ascb_L[s]', 'subSystem','Transport, extracellular', 'geneRule','');
model = addReaction(model,'r0940_s','reactionFormula','HC00250[c] <=> HC00250[s] ', 'subSystem','Transport, extracellular', 'geneRule','');
model = addReaction(model,'HMR_9191_s','reactionFormula','ser_D[c] -> ser_D[s]', 'subSystem','', 'geneRule','');
